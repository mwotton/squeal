...
>>> printSQL insertUser
WITH "u" AS (INSERT INTO "users" ("name") VALUES (($1 :: text)) RETURNING "id" AS "id", ($2 :: text) AS "email") INSERT INTO "emails" ("user_id", "email") SELECT "u"."id" AS "user_id", "u"."email" AS "email" FROM "u" AS "u"
